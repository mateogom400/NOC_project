...
- data: 2026-08-24T10:03:22+00:00
- commit: `a54dfe30ec` sul branch `G1_optimal_trajectory`
...
| **AD inverso** | **1.5** (intervallo 1.3–1.8) | precisione macchina |
...
Le differenze centrate userebbero il 24% del budget di ciclo (125 ms).
...
Dimensione del cono critico fra **4** e **45** a seconda del punto di lavoro (vale l'identità `dim(cono) = n_var − vincoli attivi`: è il complemento della saturazione, non una tendenza temporale).

| ciclo | t [s] | attivi | rango | LICQ | cono | λ_min proiettato |
|---|---|---|---|---|---|---|
| 0 | 0 | 96 | 96 | sì | 45 | +8.78e-01 |
| 95 | 60 | 98 | 98 | sì | 43 | +8.75e-01 |
| 190 | 105 | 100 | 100 | sì | 41 | +8.37e-01 |
| 285 | 153 | 97 | 97 | sì | 44 | +8.78e-01 |
| 380 | 197 | 96 | 96 | sì | 45 | +8.78e-01 |
| 475 | 242 | 105 | 105 | sì | 36 | +9.16e-01 |
| 570 | 294 | 99 | 99 | sì | 42 | +8.83e-01 |
| 665 | 359 | 137 | 137 | sì | 4 | +7.19e+00 |
| 761 | 430 | 136 | 136 | sì | 5 | +1.57e+00 |

### Biforcazione (§4.4.5, Thm 4.4.6)

Soglia fra W_obs = 200 e 300; il deployato è 120 (sotto soglia).
Sul ciclo reale 664: biforca mai = **True**.
...
### Errore di predizione (§7.2.5) — bag `industrial_plant_v3`, 762 cicli

Offset a k=0: 0.0241 m (allineamento temporale, non modello).
**Divergenza a fine orizzonte: 0.305 m**, cioè 18× l'errore di Euler e 3505× quello del punto medio.
...
|---|---|---|
| vx media [m/s] | 0.1893 | 0.3000 |
| spostamento [m] | 0.5676 | 0.8942 |
| iterazioni | 10.7 | 19.7 |

**+58% di avanzamento**; v_ref lasciava inutilizzato il 33% della velocità.


### Vincolo terminale (§7.2.5)

Slack massimo 0.000e+00 — sempre ammissibile: **True**. Costo del vincolo da +3.3% a +85.2%.

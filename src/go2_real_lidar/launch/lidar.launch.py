...
Launches the Unitree L1 LiDAR adapter for the real Go2.
...
def generate_launch_description():
    ...
    share = get_package_share_directory("go2_real_lidar")
    ...
    lidar_filter = Node(
        package="go2_real_lidar",
        executable="lidar_filter_node",
        name="go2_real_lidar_filter",
        output="screen",

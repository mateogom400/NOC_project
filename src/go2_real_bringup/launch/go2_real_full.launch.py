...
--------
  /utlidar/cloud        (Unitree L1)
        │
        ▼   robot_real_lidar.lidar_filter_node
  /lidar/points_filtered
        │                                  ┌── /global_goal ── robot_real_goal_manager
        ▼                                  ▼
...
def generate_launch_description():
    ...
    lidar_share           = get_package_share_directory("robot_real_lidar")
    planner_share         = get_package_share_directory("go2_real_planner")
    goal_share            = get_package_share_directory("robot_real_goal_manager")
